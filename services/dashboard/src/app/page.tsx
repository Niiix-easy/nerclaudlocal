        ...
        <section className="bg-gray-800 rounded-xl p-6 border border-gray-700 shadow-lg flex flex-col">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-4 mt-4 border-t border-gray-700 space-y-4">
               <Link href="/editor" className="w-full flex items-center justify-center gap-3 bg-indigo-600 text-white font-semibold py-3 px-4 rounded-lg hover:bg-indigo-700 transition-colors">
               ...
               <Link href="/storage" className="w-full flex items-center justify-center gap-3 bg-gray-700 text-white font-semibold py-3 px-4 rounded-lg hover:bg-gray-600 transition-colors">
                 <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg>
